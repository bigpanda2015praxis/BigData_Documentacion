...
class PigJobTask2(luigi.Task):
    ...
    def output(self):
        return luigi.LocalTarget("/usr/local/hadoop/luigi-1.3.0/examples/myexamples/Task2.complete")
    ...
    def pig_script_path(self):
        return '/usr/local/hadoop/luigi-1.3.0/examples/myexamples/NetflixQuery2.pig'
...
# 	luigi.run(["--local-scheduler"], main_task_cls=PigJobTask2)
